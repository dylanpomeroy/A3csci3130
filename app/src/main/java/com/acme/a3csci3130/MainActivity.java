...
public class MainActivity extends Activity {
    ...
    /**
     * Starts the create contact activity on button press.
    ...
    /**
     * Starts the edit contact activity on button press.
     * @param business the business info of the given clicked item.
     */
